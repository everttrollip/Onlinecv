<template>
    <div class="card material-table">
        <div class="table-header">
            ...
            <div class="actions">
                <a v-for="button in customButtons" href="javascript:undefined" class="nopadding" v-if="button.hide ? !button.hide : true" v-nclick="button.onclick">
        ...
        <!-- Modal -->
<div v-if="showMessageModal" class="modal fade in show"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-default"  @click="showMessageModal = false" data-dismiss="modal">Close</button>
    ...
    methods: {
        ...
        requireReview(id){
            ...
            for(var i = 0; i < this.reviews.length; i++){
                if(this.reviews[i].student_id === id){
                    flag = true
                }
            }
            return flag;
