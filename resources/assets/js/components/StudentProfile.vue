<template>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input  v-model="sports" class="form-control" placeholder="" name="sport">
                             <label class="control-label">Give yourself a point out of 10 for ...</label>
                            <input  v-model="sport" class="form-control" placeholder="" name="sport">
                        </div>
                        <div class="form-group ">
                            ...
                            <select class="form-control select2" style="width:100%" multiple="multiple" v-model="interests">
                                ...
                                <div class="form-group">
                                    ...
                                    <br><input name="avatar" type="file" class="form-control upload-file" data-max-size="2000000">
                                    </div>
                                </div>
                            <!-- /.box-body -->
  ...
  methods: {
    submit() {
        axios.post('/student/profile/update', this.$data)
                    .then(function (response) {
                        ...
                        if(response.data['firstname'] != ''){
                            ...
                            bootbox.alert({title:'Notification', message:'Something went wrong. We could not update your profile. Please try again or contact the administrators at info@onlinecv.co.za if the issue persists.'});
                        }
