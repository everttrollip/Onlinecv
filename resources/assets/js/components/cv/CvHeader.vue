<template>
    <!-- CV Header -->
        <div class="col-md-12 col-xs-12" >
            <div class="box">
                <div class="box-body">
                    <div class="col-md-2 col-xs-12" id="imageHolder">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="flex-container-row space-between">
                                ...
                                <span class="edit-icons">
                                    ...
                                    <i class="fa fa-times" v-show="dobEditable" v-on:click="dobEditable = !dobEditable"></i>
                                ...
                                <div class="flex-container-row space-between">
                                    ...
                                    <span class="edit-icons">
                                        ...
                                        <i class="fa fa-floppy-o" v-show="provinceEditable" v-on:click="provinceEditable = false; editProvince()"></i>
                                         <i class="fa fa-times" v-show="provinceEditable" v-on:click="provinceEditable = !provinceEditable"></i>
                                ...
                                <div class="flex-container-row space-between">
                                    ...
                                    <span class="edit-icons">
                                        ...
                                        <i class="fa fa-floppy-o" v-show="languagesEditable" v-on:click="languagesEditable = false; editLanguages()"></i>
                                         <i class="fa fa-times" v-show="languagesEditable" v-on:click="languagesEditable = !languagesEditable"></i>
                                        <i class="fa fa-pencil-square-o" v-show="!languagesEditable & !languagesLoading" v-on:click="languagesEditable = true"></i>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="student-contact-details col-md-4 col-xs-12">
                            <div class="info-box email col-md-12 col-xs-12">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="edit-icons">
                                        ...
                                        <i class="fa fa-times" v-show="emailEditable" v-on:click="emailEditable = !emailEditable"></i>
                            ...
                            <div class="info-box phone col-md-12 col-xs-12">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="edit-icons">
                                        ...
                                        <i class="fa fa-times" v-show="contactEditable" v-on:click="contactEditable = !contactEditable"></i>
