                            ...
                            <li class="nav-item dropdown">
                               ...
                               Register <span class="caret"></span>
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <ul>
                                        <li style="padding-top:10px;"><a class="dropdown-item" href="/register/student">Register as Student</a></li>
                                        <li style="padding-top:10px;"><a class="dropdown-item" href="/register/hub">Register as Hub</a></li>
                                        <li style="padding-top:10px;"><a class="dropdown-item" href="/register/administrator">Register as Administrator</a></li>
                                    </ul>
                            </li>
                        @else
                            <li class="dropdown">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center">
            ...
            <a href="/register/admin"></a><button class="btn btn-warning" style="width:150px;">Administrator</button></a>
