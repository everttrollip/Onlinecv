        ...
        <center data-parsed="">
            ...
            <table align="center" class="container float-center"><tbody><tr><td>
              ...
              <table class="row"><tbody><tr>
                ...
                <p style="color: #484848; line-height: 1.5;">You've received a voucher for <a href="http://onlinecv.link">OnlineCV!</a></p>
                <p>Your voucher code is: {{$voucher}}. Use this voucher to create your OnlineCV account!</p>

                <table class="spacer"><tbody><tr><td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td></tr></tbody></table>

                <center data-parsed="">
                  <table align="center" class="menu vertical float-center"><tr><td><table><tr>
                    <th class="menu-item float-center"><a href="http://localhost:8000/create-account/{{$voucher}}" target="_blank">Create Account</a></th>
