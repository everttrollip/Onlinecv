        ...
        <center data-parsed="">
            ...
            <table align="center" class="container float-center"><tbody><tr><td>
              ...
              <table class="row"><tbody><tr>
                ...
                <p style="color: #484848; line-height: 1.5;">Thank you for creating an account with <a href="http://onlinecv.link">OnlineCV!</a>
                This email is to verify that the email address you provided is correct.</p>
                <p> To verify your email address and activate your account please click on the link below.</p>

                <table class="spacer"><tbody><tr><td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td></tr></tbody></table>

                <center data-parsed="">
                  <table align="center" class="menu vertical float-center"><tr><td><table><tr>
                    <th class="menu-item float-center"><a href="http://localhost:8000/activate-account/{{$activate_token}}" target="_blank">Activate Account</a></th>
